    ...
    public function run(): void
    {
        ...
        $lisensiSmk = Lisensi::firstOrCreate(
            ...
            [
                ...
                'tanggal_kadaluarsa' => null, // Lifetime for Beli Putus
                'garansi_bugfix_hingga' => '2026-11-01', // 3 Months Bugfix Warranty
                'status' => 'active',
        ...
        $lisensiSma = Lisensi::firstOrCreate(
            ...
            [
                ...
                'tanggal_kadaluarsa' => '2027-06-15', // 1 Year SaaS
        ...
        $lisensiSmp = Lisensi::firstOrCreate(
            ...
            [
                ...
                'tanggal_kadaluarsa' => now()->addDays(12)->toDateString(), // 12 days left (Watchlist)
