...
1. **Zero Vendor Lock-in untuk Beli Putus**: Klien beli putus memegang kendali penuh atas database siswa dan guru mereka. Sistem tidak melakukan *phoning home* wajib saat proses belajar/ujian berlangsung.
