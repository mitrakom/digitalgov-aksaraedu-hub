    ...
    <AdminLayout>
        ...
        <template #header-title>
            <h1 class="text-base font-bold tracking-tight text-slate-100">
                Leads Demo & Pipeline Penjualan (CRM)
            </h1>
        </template>
            ...
            <Card class="border-slate-800 bg-slate-900">
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-xs">
                        ...
                        >
                            <tr>
                                <th class="px-4 py-3">Sekolah / Pemohon</th>
                                <th class="px-4 py-3">Kontak (WA & Email)</th>
                                <th class="px-4 py-3">Jenjang & Siswa</th>
                                <th class="px-4 py-3">Minat Model</th>
                                <th class="px-4 py-3">Status Follow-Up</th>
                        ...
                        >
                            ...
                            >
                                <td class="px-4 py-3">
                                    ...
                                    <p
                                        class="mt-0.5 text-[11px] font-medium text-emerald-400"
                                    >
                                        {{ lead.nama_pemohon }}
                                    </p>
                                </td>
                                <td class="px-4 py-3">
                                    ...
                                    <p
                                        class="max-w-[140px] truncate text-[11px] text-slate-400"
                                    >
                                        {{ lead.email }}
                                    </p>
                                </td>
                                <td class="px-4 py-3">
                                    <Badge
                                        ...
                                        >{{ lead.tipe_sekolah }}</Badge
                                    >
                                    <p class="text-[11px] text-slate-400">
                                        {{ lead.estimasi_siswa }} Siswa
                                    </p>
                                </td>
                                <td class="px-4 py-3">
                                    <Badge
                                        :variant="
                                            lead.model_minat === 'beli_putus'
                                                ? 'success'
                                                : 'info'
                                        "
                                        size="sm"
        ...
        <Modal
            ...
            title="Update Pipeline Status Follow-Up"
            maxWidth="md"
        >
            <form @submit.prevent="submitStatusUpdate" class="space-y-4">
                <div>
                    ...
                    >
                        ...
                        <option value="dihubungi">
                            Sudah Dihubungi via WA / Telepon
                        </option>
                        <option value="presentasi">
                            Tahap Presentasi / Zoom Demo
                        </option>
                        <option value="deal">Deal (Closing Kontrak)</option>
                        <option value="lost">
                            Lost (Tidak Berminat / Anggaran Belum Siap)
                        </option>
                    </select>
                </div>
